...
public class CorporationMarketOrderHistoryEntry {
    ...
    static CorporationMarketOrderHistoryEntry fromJson(Json json) {
        if (json == null) {
            return null;
        }
        CorporationMarketOrderHistoryEntry self = new CorporationMarketOrderHistoryEntry();
