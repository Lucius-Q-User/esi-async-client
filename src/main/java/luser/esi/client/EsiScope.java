...
public enum EsiScope {
    ...
    ESI_CHARACTERS_READ_AGENTS_RESEARCH_V1("esi-characters.read_agents_research.v1"),
    ...
    ESI_CALENDAR_READ_CALENDAR_EVENTS_V1("esi-calendar.read_calendar_events.v1"),
    ESI_BOOKMARKS_READ_CHARACTER_BOOKMARKS_V1("esi-bookmarks.read_character_bookmarks.v1"),
    ESI_CONTRACTS_READ_CHARACTER_CONTRACTS_V1("esi-contracts.read_character_contracts.v1"),
    ESI_INDUSTRY_READ_CHARACTER_JOBS_V1("esi-industry.read_character_jobs.v1"),
    ESI_INDUSTRY_READ_CHARACTER_MINING_V1("esi-industry.read_character_mining.v1"),
    ESI_MARKETS_READ_CHARACTER_ORDERS_V1("esi-markets.read_character_orders.v1"),
    ESI_WALLET_READ_CHARACTER_WALLET_V1("esi-wallet.read_character_wallet.v1"),
    ESI_CHARACTERS_READ_CHAT_CHANNELS_V1("esi-characters.read_chat_channels.v1"),
    ...
    ESI_CORPORATIONS_READ_CONTAINER_LOGS_V1("esi-corporations.read_container_logs.v1"),
    ESI_ASSETS_READ_CORPORATION_ASSETS_V1("esi-assets.read_corporation_assets.v1"),
    ESI_BOOKMARKS_READ_CORPORATION_BOOKMARKS_V1("esi-bookmarks.read_corporation_bookmarks.v1"),
    ESI_CONTRACTS_READ_CORPORATION_CONTRACTS_V1("esi-contracts.read_corporation_contracts.v1"),
    ESI_INDUSTRY_READ_CORPORATION_JOBS_V1("esi-industry.read_corporation_jobs.v1"),
    ESI_KILLMAILS_READ_CORPORATION_KILLMAILS_V1("esi-killmails.read_corporation_killmails.v1"),
    ESI_CORPORATIONS_READ_CORPORATION_MEMBERSHIP_V1("esi-corporations.read_corporation_membership.v1"),
    ESI_INDUSTRY_READ_CORPORATION_MINING_V1("esi-industry.read_corporation_mining.v1"),
    ESI_MARKETS_READ_CORPORATION_ORDERS_V1("esi-markets.read_corporation_orders.v1"),
    ESI_CHARACTERS_READ_CORPORATION_ROLES_V1("esi-characters.read_corporation_roles.v1"),
    ESI_WALLET_READ_CORPORATION_WALLET_V1("esi-wallet.read_corporation_wallet.v1"),
    ESI_WALLET_READ_CORPORATION_WALLETS_V1("esi-wallet.read_corporation_wallets.v1"),
    ...
    ESI_CHARACTERS_READ_NOTIFICATIONS_V1("esi-characters.read_notifications.v1"),
    ESI_LOCATION_READ_ONLINE_V1("esi-location.read_online.v1"),
    ESI_CHARACTERS_READ_OPPORTUNITIES_V1("esi-characters.read_opportunities.v1"),
    ESI_CORPORATIONS_READ_OUTPOSTS_V1("esi-corporations.read_outposts.v1"),
    ...
    ESI_CALENDAR_RESPOND_CALENDAR_EVENTS_V1("esi-calendar.respond_calendar_events.v1"),
    ...
    ESI_CORPORATIONS_WRITE_STRUCTURES_V1("esi-corporations.write_structures.v1"),
    ESI_UI_WRITE_WAYPOINT_V1("esi-ui.write_waypoint.v1");
    public final String stringValue;
    private EsiScope(String stringValue) {
       this.stringValue = stringValue;
    }
    public String getStringValue() {
        return stringValue;
    }
    public static EsiScope fromString(String str) {
        if (str == null) {
            return null;
        }
        for (EsiScope self : EsiScope.values()) {
