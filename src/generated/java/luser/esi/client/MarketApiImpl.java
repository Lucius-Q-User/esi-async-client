...
class MarketApiImpl implements MarketApi {
    ...
    public CompletableFuture<List<CharacterOrderHistoryEntry>> getCharacterOrderHistoryAllPages(int characterId) {
        return ApiClientBase.pagingHelper((page) -> getCharacterOrderHistory(characterId, null, page), (List<CharacterOrderHistoryEntry>)null);
    }
    
    @Override
    public CompletableFuture<List<StructureMarkets>> getStructureMarketAllPages(long structureId) {
        return ApiClientBase.pagingHelper((page) -> getStructureMarket(null, page, structureId), (List<StructureMarkets>)null);
    }
    ...
    public CompletableFuture<List<ActiveMarketOrder>> getMarketOrdersAllPages(OrderTypeEnum orderType, int regionId, Integer typeId) {
        return ApiClientBase.pagingHelper((page) -> getMarketOrders(null, orderType, page, regionId, typeId), (List<ActiveMarketOrder>)null);
    }
    
    @Override
    public CompletableFuture<IntArrayList> getMarketTypesAllPages(int regionId) {
        return ApiClientBase.pagingHelper((page) -> getMarketTypes(null, page, regionId), (IntArrayList)null);
    }
    
    @Override
    public CompletableFuture<List<CorporationMarketOrderHistoryEntry>> getCorporationOrderHistoryAllPages(int corporationId) {
        return ApiClientBase.pagingHelper((page) -> getCorporationOrderHistory(corporationId, null, page), (List<CorporationMarketOrderHistoryEntry>)null);
    }
    
    @Override
    public CompletableFuture<List<CorporationMarketOwner>> getOrdersAllPages(int corporationId) {
        return ApiClientBase.pagingHelper((page) -> getOrders(corporationId, null, page), (List<CorporationMarketOwner>)null);
    }
}
